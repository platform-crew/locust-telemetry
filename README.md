...
Load tests often need to integrate with your existing observability stack.
**Locust Telemetry** solves this by providing structured, log-based metrics
that can be correlated with application and infrastructure data, enabling
deeper insights and standardized monitoring.

## Installation & Quick Start

### Requirements

> Python 3.9+, locust >= 2.37.0, python-json-logger >= 3.3.0
...
uv show locust-telemetry  # validate installation
```
### Using poetry
```bash
...
- CLI plugin arguments are not supported yet; load manually in locustfile.py.
- Progress on CLI/plugin support: Locust issue #3212
...
![All Load Test Runs](./docs/source/_static/load-test-runs.png)

*Request metrics and performance overview*

![Request Dashboard 1](./docs/source/_static/request-dashboard-1.png)

*Endpoint-specific statistics*

![Request Dashboard 2](./docs/source/_static/request-dashboard-2.png)

*Errors and failures visualized*

![Request Dashboard 3](./docs/source/_static/request-dashboard-3.png)

*System metrics and CPU warnings*

![Request Dashboard 4](./docs/source/_static/request-dashboard-4.png)



> For full setup instructions, refer to the [Read the Docs examples section](https://your-docs-link/examples-section).
